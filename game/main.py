...
class MainMenu:
    ...
    def _init_ui(self):
        red_plane_button = windowgui.Button("red", 60, -60, 100, 100, hide_button=False, top_img=game.assets.IMAGES["plane-red-1"])
        blue_plane_button = windowgui.Button("blue", -60, -60, 100, 100, hide_button=False, top_img=game.assets.IMAGES["plane-blue-1"])
        green_plane_button = windowgui.Button("green", -180, -60, 100, 100, hide_button=False, top_img=game.assets.IMAGES["plane-green-1"])
        yellow_plane_button = windowgui.Button("yellow", 180, -60, 100, 100, hide_button=False, top_img=game.assets.IMAGES["plane-yellow-1"])
        ...
        play_button = windowgui.Button("play", 0, 50, 250, 50, top_img=windowgui.Text(0,0,"Play").surface)
